<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu">
      ...
      <li class="{{ Request::route()->getName() == 'admin.menuMakanan' ? ' active' : '' }}"><a class="nav-link" href="{{ route('admin.menuMakanan') }}"><i class="fa fa-columns"></i> <span>Makanan</span></a></li>
      ...
      <li class="{{ Request::route()->getName() == 'admin.transaksi' ? ' active' : '' }}"><a class="nav-link" href="{{ route('admin.transaksi') }}"><i class="fa fa-users"></i> <span>Transaksi</span></a></li>
      @endif
    </ul>
</aside>
